 ...
 * 统一音乐表格组件测试程序
 */
public class UnifiedMusicTableTest extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // 创建模拟的MusicState和BottomMusicContainer
        ...
        // 设置测试数据（先显示网络歌曲）
        musicTable.setData(networkItems, false);
        ...
        // 设置舞台
        primaryStage.setTitle("统一音乐表格测试");
        ...
        new Thread(() -> {
            try {
                ...
                javafx.application.Platform.runLater(() -> {
                    musicTable.setData(localItems, true);
                });
